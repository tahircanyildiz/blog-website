...
function HeroSection({ aboutData, loading }) {
  ...
  return (
    <section
      id="home"
      className="relative flex items-center justify-center min-h-[calc(100vh-80px)] overflow-hidden bg-gradient-to-br from-[#d8f3dc] via-white to-[#b7e4c7]"
    >
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 py-8 sm:py-16 text-center">
          ...
          {loading ? (
            ...
            <>
              <h1
                ...
                className={`text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold tracking-tight bg-gradient-to-r from-[#081c15] via-[#1b4332] to-[#2d6a4f] bg-clip-text text-transparent break-words px-2 ${
                  headingAnimation.isVisible ? 'animate-fadeInDown' : 'opacity-0'
                }`}
              >
                Merhaba, Ben <br />
                {aboutData?.name}
              ...
              <p
                ...
                className={`text-base sm:text-lg md:text-xl lg:text-2xl text-gray-600 max-w-2xl mx-auto px-4 leading-relaxed stagger-2 ${
                  descAnimation.isVisible ? 'animate-fadeInUp' : 'opacity-0'
                }`}
              >
                {aboutData?.title} <br /><br />
        ...
        <div
          ...
          className={`flex flex-col sm:flex-row gap-4 justify-center items-center stagger-3 ${
            buttonsAnimation.isVisible ? 'animate-fadeInUp' : 'opacity-0'
          }`}
        >
          <button
