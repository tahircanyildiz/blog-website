...
function ContactSection({ contactInfo, socialMedia }) {
  ...
  const getPlatformLabel = (platform) => {
    const labels = {
      ...
      medium: 'Medium', tiktok: 'TikTok', discord: 'Discord',
            ...
            <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-6">
              <div>
                ...
                <input
                  ...
                  className={`w-full px-3 py-2 sm:px-4 sm:py-3 text-sm sm:text-base border rounded-lg focus:ring-2 focus:ring-[#40916c] focus:border-[#40916c] outline-none transition-colors ${errors.name ? 'border-red-500' : 'border-gray-300'}`}
              ...
              <div>
                ...
                <input
                  ...
                  className={`w-full px-3 py-2 sm:px-4 sm:py-3 text-sm sm:text-base border rounded-lg focus:ring-2 focus:ring-[#40916c] focus:border-[#40916c] outline-none transition-colors ${errors.email ? 'border-red-500' : 'border-gray-300'}`}
              ...
              <div>
                ...
                <textarea
                  ...
                  className={`w-full px-3 py-2 sm:px-4 sm:py-3 text-sm sm:text-base border rounded-lg focus:ring-2 focus:ring-[#40916c] focus:border-[#40916c] outline-none transition-colors resize-none ${errors.message ? 'border-red-500' : 'border-gray-300'}`}
